      ...
      <div class="row">
              ...
              <form role="form" action="{{route('post.update',$post->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" placeholder="Enter Post title" value="{{$post->title}}" name="title">
                  </div>
                  <div class="form-group">
                    <label for="subtitle">Post SubTitle</label>
                    <input type="text" class="form-control" id="subtitle" placeholder="Enter Post subtitle" value="{{$post->subtitle}}" name="subtitle">
                  </div>
                   <div class="form-group">
                    <label for="slug">Post Slug</label>
                    <input type="text" class="form-control" id="slug" value="{{$post->slug}}" placeholder="Enter Post slug" name="slug">
                  </div>
          ...
          <div class="card ">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                <textarea  id="editor" name="body" placeholder="Place some text here"
                          style="width: 100%; height: 700px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$post->body}}</textarea>
              </div>
